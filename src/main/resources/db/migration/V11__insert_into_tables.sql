...
(1, 'Arthritis', 'Chronic arthritis, requires regular monitoring and anti-inflammatory medication.', '2024-10-01', '2025-01-01', 'Follow-up in 3 months.', 1);
...
(1, 1, 1, 'Administer 50mg twice daily for 7 days.', '50mg', '2024-10-01', '2024-11-01', 3, '2024-12-01');

INSERT INTO vaccination_record (pet_id, vaccine_name, date_administered, next_due_date, status, notes, vet_id, cost) 
VALUES 
(1, 'Rabies', '2024-09-01', '2025-09-01', 'Completed', 'Next vaccination in 12 months.', 1, 45.00),
(1, 'Distemper', '2024-09-01', '2025-09-01', 'Completed', 'Next vaccination in 12 months.', 1, 30.00);
